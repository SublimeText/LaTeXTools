...
[Sioyek](https://sioyek.info/) is a PDF viewer with a focus on technical books and research papers. It autoreloads the document so you can preview the changes as you edit the latex file. You can also jump between the corresponding locations in PDF and latex files with one click. 
