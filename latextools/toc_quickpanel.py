...
def _make_caption(toc_indentations, com, indent_offset):
    ...
    short = {"subsubsection": "sss", "minisec": "msec", "label": "L"}.get(
        com.command, com.command[0:3]
    )
    short = short.title()
...
class show_toc_quickpanel(quickpanel.CancelEntriesQuickpanel):
    ...
    def __init__(self, view, ana, only_file=None):
        ...
        self.add_item(quickpanel.AT_END, self.__show_string, done_handler=self.__show_labels)
